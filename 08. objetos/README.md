...
Nesta seção, explorei como representar elementos do mundo real no código através de **Objetos** e como transportar esses dados de forma eficiente usando **JSON**.


## 🏗️ 1. Orientação a Objetos (Básico)
